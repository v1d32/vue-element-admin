<template>
  <div class="app-container">
    ...
    <div :key="key" style="margin-top:30px;">
      ...
      <div>
        <span v-permission="['superadmin', 'admin','editor']" class="permission-alert">
          Both
          <el-tag class="permission-tag" size="small">admin</el-tag> and
          <el-tag class="permission-tag" size="small">editor</el-tag> can see this
        </span>
        <el-tag v-permission="['superadmin', 'admin','editor']" class="permission-sourceCode" type="info">
          v-permission="['superadmin', 'admin','editor']"
        </el-tag>
      </div>
    </div>
    ...
    <div :key="'checkPermission'+key" style="margin-top:60px;">
      ...
      <el-tabs type="border-card" style="width:550px;">
        <el-tab-pane v-if="checkPermission(['superadmin', 'admin'])" label="Admin">
          Admin can see this
        ...
        <el-tab-pane v-if="checkPermission(['superadmin', 'admin','editor'])" label="Admin-OR-Editor">
